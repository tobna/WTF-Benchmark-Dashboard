...
html:
	...
	sed -i 's/_reload-hash/_reload-hash.json/g' 127.0.0.1:8050/_dash-component-suites/dash/dash-renderer/build/*.js
	...
	mv 127.0.0.1:8050/_reload-hash 127.0.0.1:8050/_reload-hash.json
